...
int main() {
    ...
    if (str=="p") {
        ...
        cout << "SU FRACCION ES: " << (entero*pow(10, it)+decimal)-entero << " / " << pow(10, it)-1;
    } else if (str=="m"){
        ...
        cout << "SU FRACCION ES: " << (entero*pow(10, (itp+itnp))+decimalnp*pow(10, itp)+decimalp)-(entero*pow(10, itnp)+decimalnp) << " / " << (pow(10, (itp+itnp))-pow(10, itnp));
    }
